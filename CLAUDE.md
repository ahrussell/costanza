...
- **R2 bucket** (`costanza-public-images`, public, served at `https://images.thehumanfund.com`): Holds `<image>/disk.tar.gz` + `<image>/metadata.json`. R2 egress is $0/GB so consumers pull free.
