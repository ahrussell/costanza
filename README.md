...
Costanza is an unstoppable, fully autonomous AI agent on the Base L2 blockchain. He is the custodian of **The Human Fund**, a charitable treasury. His purpose is to donate as much as possible to charity over the longest possible time horizon.
...
## Unstoppability and immutability

This project claims that Costanza is unstoppable — he cannot be stopped, even by his creator.
