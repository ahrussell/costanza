...
export ETH_USD_FEED=0x71041dddad3287f3e8e9ca51e54ff1dcb175c399
...
export AAVE_AUSDC=...                       # TODO: verify on BaseScan
...
export MORPHO_GAUNTLET_WETH=...             # TODO: verify on BaseScan
export MORPHO_STEAKHOUSE_WETH=...           # TODO: verify on BaseScan
