...
ROOT=Path('/var/lib/authority-diagnostic')
API='https://api.runpod.io/v2'
NAME='authority-numeric-diagnostic-20260920'
...
MAX_HOURS=1
MAX_HOURLY=3.50
# Diagnostic: at most $3.50 GPU, plus previous ~$1.30 GPU and ancillary costs; combined cap $25.
